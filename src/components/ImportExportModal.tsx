        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          {activeTab === 'template' && (
            <div className="flex-1 overflow-auto p-5 space-y-3">
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3 text-xs text-cyan-200 space-y-1">
                <div className="font-semibold flex items-center gap-1.5">
                  <CheckCircle2 size={13} />
                  How it works
                </div>
                <ol className="list-decimal list-inside space-y-1 text-cyan-100/80">
                  <li>Click <b>"Copy Template"</b> below</li>
                  <li>Paste into your AI chat with a prompt like: <i>"Fill this pentest playbook with SSH enumeration commands"</i></li>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-cyan-500 text-slate-950 hover:bg-cyan-400 transition-colors"
                >
          ...
          {activeTab === 'import' && (
            <div className="flex-1 overflow-auto p-5 space-y-3">
              ...
              <textarea
                ...
                className="w-full h-[30vh] p-3 rounded-lg bg-slate-950 border border-slate-800 text-slate-200 font-mono text-xs outline-none resize-none focus:border-cyan-500/50"
              />
          ...
          {activeTab === 'export' && (
            <div className="flex-1 overflow-auto p-5 space-y-3">
              <div className="text-xs text-slate-400">
                Full markdown export of <b className="text-slate-200">{playbook.title}</b> with
                all sections, commands, tags and variables.
              </div>
...
function applyParsed(
  ...
  for (const section of parsed.sections) {
    ...
    setTimeout(() => {
      ...
      const matchingSections = (currentPlaybook.sections || []).filter((s) => s.title === sectionTitle);
