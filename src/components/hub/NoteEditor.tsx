...
export function NoteEditor({ note }: Props) {
  ...
  // Use note props directly - no local state sync issues
  ...
  }, [newTag, note.tags, note.id, updateNote]);

  const removeTag = useCallback((tag: string) => {
    updateNote(note.id, { tags: note.tags.filter(t => t !== tag) });
  }, [note.tags, note.id, updateNote]);
  ...
  return (
    ...
    >
      ...
      >
        <button onClick={() => insertText('# ')} title="Heading 1" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Heading1 size={14} /></button>
        <button onClick={() => insertText('## ')} title="Heading 2" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Heading2 size={14} /></button>
        <button onClick={() => insertText('**', '**')} title="Bold" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Bold size={14} /></button>
        <button onClick={() => insertText('*', '*')} title="Italic" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Italic size={14} /></button>
        <button onClick={() => insertText('`', '`')} title="Inline Code" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Code size={14} /></button>
        <button onClick={() => insertText('[', '](url)')} title="Link" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Link size={14} /></button>
        <button onClick={() => insertText('- ')} title="List" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><List size={14} /></button>
        <button onClick={() => insertText('> ')} title="Quote" className="p-1.5 rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" style={{ color: mutedColor }}><Quote size={14} /></button>
